...
class _FavoritesScreenState extends State<FavoritesScreen> {
  ...
  void _searchProducts(String query) {
    setState(() {
      if (query.isEmpty) {
        ...
        _filteredProducts = _favoriteProducts.where((product) =>
  ...
  Future<void> _removeFavorite(Product product) async {
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('${AppStrings.favoriteRemoved}: ${product.name}'),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Error al eliminar favorito: $e'),
            backgroundColor: AppColors.error,
          ),
        );
      }
  ...
  Widget _buildProductCard(Product product) {
    return Semantics(
      label: 'Producto favorito: ${product.name}',
      child: CustomCard(
        margin: const EdgeInsets.only(bottom: AppSizes.paddingMedium),
        borderColor: AppColors.redAccent.withOpacity(0.3),
        borderWidth: 2,
        child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Semantics(
                      label: AppStrings.removeFromFavorites,
                      hint: 'Toca para quitar de favoritos',
                      button: true,
                      child: InkWell(
